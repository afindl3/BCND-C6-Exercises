...
contract ExerciseC6D {
  ...
  struct ResponseInfo {
    ...
    mapping(uint8 => address[]) responses;    // Mapping key is the status code reported
                                                // This lets us group responses and identify the
                                                // response that majority of the oracles submit
  }
  ...
  // For the response to be accepted, there must be a pending request that is open and matches one of the 
  // three Indexes randomly assigned to the oracle at the time of registration (i.e. uninvited oracles are not welcome)
